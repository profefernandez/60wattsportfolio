...
export async function generateMetadata({ params }: WebsiteCaseStudyPageProps): Promise<Metadata> {
  return {
    title: `Website Project: ${params.slug}`,
  }
}

export default function WebsiteCaseStudyPage({ params }: WebsiteCaseStudyPageProps) {
  return (
      ...
      <div className="max-w-4xl mx-auto">
        <article>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-muted">
              This is a placeholder for the website case study with slug: <code className="text-primary">{params.slug}</code>
            </p>
          </div>
        </article>
      </div>
